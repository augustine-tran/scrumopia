...
class ProjectUserController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('ProjectUser');
	...
	{
		$model=new ProjectUser('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['ProjectUser']))
			$model->attributes=$_GET['ProjectUser'];
	...
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='project-user-form')
		{
