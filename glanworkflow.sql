...
insert  into `authitem`(`name`,`type`,`description`,`bizrule`,`data`) values ('admin',2,NULL,NULL,NULL),('client',2,NULL,NULL,NULL),('guest',2,NULL,NULL,NULL);
...
insert  into `authitemchild`(`parent`,`child`) values ('admin','client'),('client','guest');
